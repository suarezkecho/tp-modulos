...
if __name__ == "__main__":
    ...
    respuesta_IMC,_ = calcular_IMC(persona["peso"], persona["altura_m"])
    print(f"Tu IMC: {respuesta_IMC}, {_}")
    respuesta_GC, mensaje_GC = calcular_porcentaje_grasa(respuesta_IMC,persona["peso"],persona["altura_m"],persona["edad"],persona["valor_genero_GC"])
    ...
    respuesta_calorias_actividad = calcular_calorias_en_actividad(respuesta_TMB, persona["peso"], persona["altura_cm"], persona["edad"], persona["valor_genero_TMB"], persona["valor_actividad"])
    print(f"Las calorias que gastas en actividad: {respuesta_calorias_actividad}")
    respuesta_recomendacion_adelgazar = consumo_calorias_recomendado_para_adelgazar(respuesta_TMB, persona["peso"], persona["altura_cm"], persona["edad"], persona["valor_genero_TMB"])
